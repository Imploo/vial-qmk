...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
		...
		KC_TAB,          KC_Q,  KC_W,  KC_E,  KC_R,  KC_T,  KC_4, KC_5, KC_6,                           KC_Y, KC_U,   KC_I,   KC_O,   KC_P,     KC_LBRC,
		KC_NUHS,         KC_A,  KC_S,  KC_D,  KC_F,  KC_G,  KM_1, KC_2, KC_3,                           KC_H, KC_J,   KC_K,   KC_L,   KC_SCLN,	KC_QUOT,
		LCTL_T(KC_LEFT), KC_Z,  KC_X,  KC_C,  KC_V,  KC_B, KC_NC, KC_0, KC_NC,                          KC_N, KC_M,  KC_COMM, KC_DOT, KC_SLSH,  RCTL_T(KC_RIGHT),
